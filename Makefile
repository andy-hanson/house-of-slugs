...
all: test bin/house-of-slugs.jar index.js
...
serve: index.js bin/puzzles
	( trap 'kill 0' INT; keen build src --out index.js --watch & keen serve.keen & wait )
index.js: $(SRC_FILES)
	keen build src --out index.js
